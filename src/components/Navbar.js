  ...
  return (
    <nav className="mb-10 items-center flex justify-between py-[2px]">
          ...
          {/* <img className="mx-2 w-10"src={} alt="logo"></img> */}
            ...
            <a href="https://drive.google.com/file/d/1dbDm7cWKWsyPJZSyNOUKy9tTe63i-tv4/view" target="_blank" rel="noopener noreferrer"><TbFileCv style={{width:"25px", height:"25px"}}> </TbFileCv></a>
             </div>
           </nav>
  )
}
